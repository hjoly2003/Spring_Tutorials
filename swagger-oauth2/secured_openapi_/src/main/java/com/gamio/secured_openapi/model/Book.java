...
/**
 * [N]:openapi - The {@code @Schema} annotation is used to describe this in the OpenAPI documentation system.
 */
...
public class Book {
  ...
  /**
   * [N]:openapi - The {@code @JsonProperty} and {@code @Schema} annotation is used to describe the members of this class in the OpenAPI documentation system.
   */
