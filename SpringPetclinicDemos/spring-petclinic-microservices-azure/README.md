...
For Azure Deployment, see [Présentation de l’exemple d’application](https://docs.microsoft.com/fr-ca/azure/spring-cloud/quickstart-sample-app-introduction?pivots=programming-language-java).
