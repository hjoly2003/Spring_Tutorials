...
You will build a gateway using https://cloud.spring.io/spring-cloud-gateway/[Spring Cloud Gateway] within a Spring Boot project.
...
----
include::src/main/java/gateway/Application.java[tag=fallback]
----
...
[source,java,tabsize=2]
----
include::src/main/java/gateway/Application.java[tag=uri-configuration]
----
...
[source,java,tabsize=2,indent=0]
----
include::src/main/java/gateway/Application.java[tag=route-locator]
----
...
[source,java,tabsize=2]
----
include::src/main/java/gateway/Application.java[tag=code]
----
...
[source,java,tabsize=2]
----
include::src/test/java/gateway/ApplicationTest.java[tag=code]
----

Our test takes advantage of http://wiremock.org/[WireMock]. To use WireMock you need to the following dependencies to your classpath.
...
WireMock starts up a server that can mock the APIs from HTTPBin. The first thing to notice
